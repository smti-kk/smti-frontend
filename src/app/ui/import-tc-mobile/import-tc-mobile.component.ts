...
import {IMPORT_LOCATION, IMPORT_TC_INTERNET, IMPORT_TC_MOBILE, IMPORT_TRUNK_CHANNEL} from '@core/constants/api';
import {saveAs} from 'file-saver';

@Component({
  selector: 'import-tc-mobile-page',
  templateUrl: './import-tc-mobile.component.html',
  styleUrls: ['./import-tc-mobile.component.scss']
})
export class ImportTcMobileComponent implements OnInit {
  ...
  private sendFile(file: File) {
    this.http.post(IMPORT_TC_MOBILE, this.createForm(file), {responseType: 'blob'})
      .subscribe(response => {
