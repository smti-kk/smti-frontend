...
import {IMPORT_LOCATION, IMPORT_TC_INTERNET, IMPORT_TC_POST, IMPORT_TRUNK_CHANNEL} from '@core/constants/api';
...
export class ImportTcPostComponent implements OnInit {
  ...
  private sendFile(file: File) {
    this.http.post(IMPORT_TC_POST, this.createForm(file), {responseType: 'blob'})
      .subscribe(response => {
