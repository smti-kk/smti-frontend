...
import {IMPORT_LOCATION, IMPORT_TC_INTERNET, IMPORT_TC_PAYPHONE, IMPORT_TRUNK_CHANNEL} from '@core/constants/api';
...
export class ImportTcPayphoneComponent implements OnInit {
  ...
  private sendFile(file: File) {
    this.http.post(IMPORT_TC_PAYPHONE, this.createForm(file), {responseType: 'blob'})
      .subscribe(response => {
